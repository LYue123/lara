...
<body>
<h1><font face="verdana"> 学生信息管理网站 </font></h1>
<br/>
<div id="one">
    <a href="<?php echo U('User/register');?>">注册账号</a>
    <a href="<?php echo U('User/register');?>">忘记密码</a>
    <a href="<?php echo U('Admin/index/index');?>">管理登录</a>
</div>
<hr>
<hr>
...
<div id="two">
    <form action="<?php echo U('User/login');?>" method="post">
        <p>学 号：<input type="text" name="s_no"/></p>
